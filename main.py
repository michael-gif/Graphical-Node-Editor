...
class App(tk.Tk):
    ...
    def create_new_node(self):
        ...
        header_color = tk.Variable(content, (129, 52, 75))
        ...
        header_color_sample = tk.Entry(content, disabledbackground=_from_rgb(header_color.get()), state='disabled')
        header_color_sample.insert(tk.END, '129, 52, 75')
